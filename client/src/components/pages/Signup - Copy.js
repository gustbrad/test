		...
		return (
            ...
            <div className="form-group col-md-12">
                ...
                <input
                  type="radio"
                  id="musician"
                  checked={this.state.value === "band"}
                  onChange={() => this.handleRadioButton("band")}
                />
                <label htmlFor="bandName">Musician</label>
                <input
                  type="radio"
                  id="band"
                  checked={this.state.value === "musician"}
                  onChange={() => this.handleRadioButton("musician")}
                />
							</div>
